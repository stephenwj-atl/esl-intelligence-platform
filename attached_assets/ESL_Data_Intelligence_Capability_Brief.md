...
| 18 | **NEPA Regulatory Intelligence** | NEPA Jamaica (nepa.gov.jm) — automated multi-page web scraping | **156 regulatory documents** scraped across 4 NEPA data sources: **40 EIA projects** (with annexes — air emissions, fauna/flora, noise, social impact assessments), **99 NRCA/TCPA Board Decisions** (monthly permit decisions from 2019-2026 across 10 paginated pages), **2 enforcement instrument listings**, and **7 public consultation documents**. Plus **34 archive documents** from the 2020 archive site. Classified by project type (5 categories) and parish (6 parishes). Regulatory density scoring for Jamaica's permitting landscape. | Jamaica (156 documents, 99 board decisions, 40 EIA projects) |

**Total: 4,880+ data records across 117 dataset types, 17 Caribbean countries, 18 automated pipelines.**
