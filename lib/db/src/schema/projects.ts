...
export const projectsTable = pgTable("projects", {
  ...
  investmentAmount: text("investment_amount").notNull().default("0"),
  ...
  delayRiskPercent: text("delay_risk_percent").notNull(),
  costOverrunPercent: text("cost_overrun_percent").notNull(),
  covenantBreachPercent: text("covenant_breach_percent").notNull(),
